...
const passwordStrength = computed(() => {
    ...
    const levels = [
        { score: 0, text: '', color: '' },
        { score: 1, text: 'Sehr schwach', color: '#ef4444' },
        { score: 2, text: 'Schwach', color: '#f97316' },
        { score: 3, text: 'Mittel', color: '#eab308' },
        { score: 4, text: 'Stark', color: '#22c55e' },
        { score: 5, text: 'Sehr stark', color: '#15803d' }
    ]
...
<template>
    <Head title="Registrieren - J-Chess" />
        ...
        <div class="auth-content">
            ...
            <div class="auth-header">
                ...
                <div class="brand">
                    ...
                    <p class="brand-subtitle">Registrieren</p>
                </div>
            </div>
            ...
            <div class="auth-card">
                <div class="card-header">
                    <h2 class="card-title">Willkommen bei J-Chess!</h2>
                    <p class="card-subtitle">Erstellen Sie Ihr Konto und beginnen Sie zu spielen</p>
                </div>
                ...
                <form @submit.prevent="submit" class="auth-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                ...
                                class="form-input"
                                :class="{
                                    'form-input--error': form.errors.password_confirmation || !passwordsMatch,
                                    'form-input--success': form.password_confirmation && passwordsMatch
                                }"
                            ...
                            <button
                                ...
                                title="Passwort anzeigen/verbergen"
                            >
                                <svg v-if="showPasswordConfirmation" viewBox="0 0 24 24">
                        ...
                        <div v-if="form.password_confirmation && !passwordsMatch" class="form-error">
                            Die Passwörter stimmen nicht überein
                        </div>
                        <div v-if="form.password_confirmation && passwordsMatch" class="form-success">
                    ...
                    >
                        ...
                        <span v-if="!form.processing">Konto erstellen</span>
                ...
                <div class="card-footer">
                    <p class="footer-text">
                        Bereits ein Konto?
                        <button @click="goToLogin" class="footer-link">
                            Jetzt anmelden
                        </button>
                    </p>
                </div>
            ...
            <div class="auth-quote">
                <p class="quote-text">
                    "In der Eröffnung sei ein Spieler ein Bücherwurm, im Mittelspiel ein Künstler und im Endspiel eine Maschine."
                </p>
                <p class="quote-author">— Rudolf Spielmann</p>
            </div>
        </div>
    </div>
</template>
